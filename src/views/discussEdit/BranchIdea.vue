  ...
  <div class="app-container">
      ...
      <div class="main-content">
        <el-form ref="queryParams" :model="queryParams" label-width="80px" label-position="top">
          <el-row>
            ...
            <el-col :md="4">
              <el-form-item label="部门负责人" prop="projectName">
    ...
    <div class="main-wrapper">
      ...
      <div class="main-content">
        ...
        <el-table-column prop="projectName" label="部门名称" width="220" align="center" sortable />
        <el-table-column prop="projectMemo" label="部门负责人" :show-overflow-tooltip="true" align="center" sortable />
        <el-table-column prop="projectLeader" label="联系方式" width="150" align="center" sortable />
        <el-table-column prop="projectStatus" label="部门意见" :show-overflow-tooltip="true" align="center" sortable />
    ...
    <el-dialog title="部门意见" :visible.sync="createVisible" :close-on-click-modal="false" :close-on-press-escape="false"
      width="55%">
      <div class="ideaBody">
        <div class="content">
