  ...
  <div class="app-container">
    ...
    <div class="main-wrapper">
      ...
      <div class="main-content">
        ...
        <el-table-column prop="projectName" label="甲方单位" width="220" align="center" sortable />
        <el-table-column prop="projectMemo" label="甲方负责人" :show-overflow-tooltip="true" align="center" sortable />
        <el-table-column prop="projectLeader" label="联系方式" width="150" align="center" sortable />
        <el-table-column prop="projectStatus" label="甲方意见" :show-overflow-tooltip="true" align="center" sortable />
    ...
    <el-dialog title="甲方意见" :visible.sync="createVisible" :close-on-click-modal="false" :close-on-press-escape="false"
      width="55%">
      <div class="ideaBody">
        <div class="content">
